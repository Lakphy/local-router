/**
 * OpenAI Completions → Anthropic Messages 适配器
 *
 * 客户端使用 OpenAI Chat Completions 协议 (/v1/chat/completions)，
 * 上游 provider 使用 Anthropic Messages 协议 (/v1/messages)。
 *
 * 配置示例（零参数）：
 *   { "package": "./packages/plugin-adapter-completions-to-anthropic" }
 */
...
const definition: PluginDefinition = {
  name: 'adapter-completions-to-anthropic',
  version: '0.1.0',
